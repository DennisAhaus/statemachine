...
var EventEmitter = require("events").EventEmitter,
    StateNotFoundError = require("./errors").StateNotFoundError,
    AsyncDispatcher = require("./asyncDispatcher"),
    SyncDispatcher = require("./syncDispatcher"),
    Utils = require('./utils');
...
class StateMachine extends EventEmitter {
    ...
    constructor(name) {
        ...
        this._name = name || "this" + Utils.getRandomInt()
        this._stateRules = {};
